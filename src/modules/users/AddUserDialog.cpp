...
void AddUserDialog::buttonCreate_clicked()
{
    ...
    // Add user
    KAuth::Action installActionAdd( QLatin1String( "org.openmandriva.kcm.users.add" ) );
    installActionAdd.setHelperId( QLatin1String( "org.openmandriva.kcm.users" ) );
    QVariantMap args;
    ...
    // Set password
    KAuth::Action installActionUsersChangePassword( QLatin1String( "org.openmandriva.kcm.users.changepassword" ) );
    installActionUsersChangePassword.setHelperId( QLatin1String( "org.openmandriva.kcm.users" ) );
    args.clear();
