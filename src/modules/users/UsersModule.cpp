...
PageUsers::buttonImage_clicked()
{
    ...
    if ( !copyDest.isEmpty() )
    {
        KAuth::Action installAction( QLatin1String( "org.openmandriva.kcm.users.changeimage" ) );
        installAction.setHelperId( QLatin1String( "org.openmandriva.kcm.users" ) );
        QVariantMap args;
...
PageUsers::buttonRemoveUser_clicked()
{
    ...
    // Remove user
    KAuth::Action installAction( QLatin1String( "org.openmandriva.kcm.users.remove" ) );
    installAction.setHelperId( QLatin1String( "org.openmandriva.kcm.users" ) );
    QVariantMap args;
